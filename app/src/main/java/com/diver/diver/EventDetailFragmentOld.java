...
public class EventDetailFragmentOld extends Fragment implements AppBarLayout.OnOffsetChangedListener, NestedScrollView.OnScrollChangeListener {
    private Event mEvent;
    private float OriginX, OriginY;
    private int mMaxScrollSize;
    private AppBarLayout appBarLayout;
    private View myView;
    private EventDetailFragmentOld mContext = this;
